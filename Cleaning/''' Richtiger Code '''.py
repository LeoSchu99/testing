...
'''
# eine ganz bestimmte Datei laden


# Spezifische Datei angeben
file_name = "siab_r_7521_v1_female_nocens.dta"  # Ersetze mit dem gewünschten Dateinamen
file_path = DATA_FOLDER / file_name  # Erstelle den vollständigen Pfad
...
# Erstellung der Alter-Variablen. Ich muss mich hier natürlich ncoh auf die richtigen Vairbalen festlegen. gebjahr und begorig als year_column (???)
import pandas as pd
